  ...
  },
  {
    ...
    answer: (
      <div className="space-y-3">
        ...
        <ul className="grid grid-cols-2 gap-2 pt-1 font-semibold text-[#0A0A0A]">
        ...
        <p className="pt-2">As long as your business identity remains the same, we'll keep your website content updated.</p>
      </div>
    )
  },
  {
    ...
    answer: (
      <div className="space-y-3">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-1 font-semibold text-[#0A0A0A]">
        ...
        <p className="pt-2">These requests are considered development work and are charged separately.</p>
      </div>
    )
  },
  {
    ...
    answer: (
      <div className="space-y-3">
        ...
        <p className="pt-2">can be added at any time for an additional development fee based on the complexity of the feature.</p>
      </div>
    )
  },
  {
    ...
    answer: (
      <div className="space-y-3">
        ...
        <p>The ₹499/month Care Plan is a managed website subscription. If you cancel your plan, your website, hosting, maintenance, support, and content updates will be discontinued, as these services are available only while your subscription is active.</p>
        <p>If you would like to continue using your website without a monthly subscription, you can choose our ₹4,999 One-Time Plan, which provides full website ownership.</p>
      </div>
    )
  },
  {
  ...
  },
  {
    ...
    answer: (
      <div className="space-y-3">
        ...
        <p>For the ₹4,999 One-Time Plan, hosting is not included after delivery. You can host the website yourself or choose one of our maintenance plans.</p>
      </div>
    )
  },
  {
  ...
  },
  {
    ...
    answer: (
      <div className="space-y-3">
        ...
        <p>This allows us to provide professionally designed business websites at an affordable monthly price while maintaining quality, performance, and ongoing support.</p>
      </div>
    )
  }
]
...
export function FAQ({ onOpenModal }: FAQProps) {
  ...
  return (
    <section ref={sectionRef} className="py-24 md:py-32 bg-[#FAFAFA] relative overflow-hidden" id="faq">
      ...
      <div className="max-w-[1300px] mx-auto px-6 md:px-12 relative z-10">
        ...
        {/* SECTION HEADER WITH STEPPED ENTRANCE */}
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          >
            ...
            <span className="text-[11px] font-bold text-[#2563EB] tracking-wider uppercase">❓ FAQ</span>
          </motion.div>
          ...
          >
            Questions people usually ask <br className="hidden sm:block" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          {/* LEFT SIDE: ANIMATED SUPPORT CARD (4 COLS) */}
          <motion.div 
          ...
          >
            <motion.div 
              ...
              className="bg-white border-2 border-[#2563EB] rounded-[32px] p-8 shadow-xl relative overflow-hidden flex flex-col justify-between group transition-all duration-300"
            >
              {/* Floating Backlight Particle Glow */}
              <div className="absolute top-0 right-0 w-48 h-48 bg-blue-500/10 rounded-full blur-2xl pointer-events-none group-hover:bg-blue-500/20 transition-colors" />

              <div>
                <div className="flex items-center justify-between mb-6">
                  <div className="w-12 h-12 rounded-2xl bg-blue-50 text-[#2563EB] border border-blue-100 flex items-center justify-center font-bold text-xl shadow-2xs">
                    💬
                  </div>
                  
                  {/* Blinking Response Badge */}
                ...
                <div className="space-y-3 mb-8">
                  ...
                  <motion.div 
                    whileHover={{ x: 4 }}
                    className="flex items-center gap-3 bg-gray-50/80 border border-gray-200/80 p-3 rounded-xl text-xs font-semibold text-[#0A0A0A] transition-all"
                  >
                    <motion.div 
                      animate={{ scale: [1, 1.15, 1] }} 
                      transition={{ repeat: Infinity, duration: 2.5, ease: "easeInOut" }}
                      className="p-1.5 bg-green-50 text-green-600 rounded-lg shrink-0"
                    >
                  ...
                  <motion.div 
                    whileHover={{ x: 4 }}
                    className="flex items-center gap-3 bg-emerald-50/60 border border-emerald-100 p-3 rounded-xl text-xs font-bold text-emerald-900 transition-all"
                  >
              ...
              <motion.button 
                ...
                whileTap={{ scale: 0.97 }}
                className="w-full bg-[#2563EB] text-white font-bold text-sm py-3.5 rounded-xl shadow-md hover:bg-blue-700 transition-all flex items-center justify-center gap-2 group/btn cursor-pointer"
              >
          ...
          {/* RIGHT SIDE: STAGGERED SPRING ACCORDION (8 COLS) */}
          <motion.div 
            ...
            {faqList.map((item, idx) => {
              ...
              return (
                <motion.div 
                  ...
                  whileHover={{ y: -4, boxShadow: "0 20px 40px -15px rgba(37,99,235,0.12)" }}
                  className={`border rounded-2xl overflow-hidden relative transition-colors duration-300 ${
                    isOpen 
                ...
                >
                  ...
                  {isOpen && (
                    <motion.div 
                      ...
                      animate={{ scaleY: 1 }}
                      exit={{ scaleY: 0 }}
                      className="absolute left-0 top-0 bottom-0 w-1.5 bg-[#2563EB] rounded-l-2xl z-20"
                    />
                  )}

                  <button
                    onClick={() => toggleAccordion(idx)}
                    className="w-full p-5 md:p-6 text-left flex items-center justify-between gap-4 cursor-pointer relative z-10"
                  >
                    <span className={`text-sm md:text-base font-sans transition-colors duration-200 ${
                    ...
                    <motion.div 
                      ...
                      className={`p-2 rounded-xl shrink-0 transition-colors ${
                        isOpen ? 'bg-[#2563EB] text-white shadow-xs' : 'bg-gray-100 text-gray-500 group-hover:text-blue-600'
                      }`}
                    >
                      <ChevronDown size={18} />
                    </motion.div>
                  ...
                  <AnimatePresence initial={false}>
                    {isOpen && (
                      ...
                      >
                        <div className="px-5 pb-6 md:px-6 md:pb-6 relative z-10">
                          
                          {/* Animated Left-to-Right Divider Line */}
                          <motion.div 
                            initial={{ scaleX: 0 }}
                            animate={{ scaleX: 1 }}
                            transition={{ duration: 0.4, ease: "easeOut" }}
                            className="h-px bg-blue-100 origin-left mb-4"
                          />

                          {/* Answer Fade with Upward Shift */}
                          <motion.div 
