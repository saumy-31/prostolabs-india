...
// --- INTERACTIVE MULTI-DEVICE ILLUSTRATION (3D Parallax, Cursor Journey & Glow) ---
function MultiDeviceIllustration() {
  ...
  return (
    <div 
      ...
      className="relative flex-1 w-full flex items-center justify-center my-2 py-4 overflow-visible cursor-pointer group/stage"
    >
      {/* SOFT AMBIENT BLUE RADIAL GLOW WITH PULSE */}
      <motion.div 
        style={{ x: glowX }}
        animate={{ scale: [1, 1.15, 1], opacity: [0.2, 0.35, 0.2] }}
        transition={{ repeat: Infinity, duration: 5, ease: "easeInOut" }}
        className="absolute w-[280px] sm:w-[380px] h-[200px] sm:h-[250px] bg-gradient-to-tr from-[#2563EB] via-blue-500 to-cyan-400 rounded-full blur-3xl pointer-events-none z-0"
      />

      {/* ANIMATED SYNC CONNECTION PULSE LINE (SVG) */}
      ...
      <motion.div 
        ...
        className="absolute top-1 right-4 sm:right-10 z-30 bg-white/95 border border-blue-100 shadow-xl backdrop-blur-md px-3.5 py-1.5 rounded-full text-[10px] font-bold text-[#2563EB] flex items-center gap-1.5 pointer-events-none"
      >
      ...
      <motion.div 
        ...
        animate={{ y: [0, -6, 0] }}
        transition={{ repeat: Infinity, duration: 5, ease: "easeInOut" }}
        className="w-[280px] sm:w-[340px] md:w-[380px] h-[190px] sm:h-[220px] bg-[#090D16] rounded-2xl border border-gray-800 p-2 shadow-2xl relative z-10 group-hover/stage:border-blue-500/50 transition-colors duration-300"
      >
        {/* Glass Reflection Sheen */}
        <motion.div 
          animate={{ x: ['-100%', '200%'] }}
          transition={{ repeat: Infinity, duration: 7, ease: "easeInOut", repeatDelay: 2.5 }}
          className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent skew-x-12 rounded-2xl pointer-events-none z-20"
        />

        <div className="w-full h-full bg-[#0F172A] rounded-xl p-3 flex flex-col gap-2.5 overflow-hidden border border-white/5 relative">
          ...
          <div className="flex items-center justify-between border-b border-white/10 pb-2">
            ...
            <div className="flex items-center gap-1 text-[9px] font-mono text-gray-300 bg-white/5 px-2.5 py-0.5 rounded-md border border-white/5">
          ...
          <div className="flex-1 flex flex-col justify-between pt-1 relative">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="w-5 h-5 rounded-md bg-[#2563EB] flex items-center justify-center text-[10px] text-white font-bold">P</div>
                <div className="w-20 h-2 bg-white/70 rounded-full" />
              </div>
              <motion.div 
                whileHover={{ scale: 1.08 }}
                className="w-14 h-4 bg-[#2563EB] rounded-md flex items-center justify-center text-[8px] text-white font-bold cursor-pointer"
              >
                Contact
              </motion.div>
            </div>
            ...
            <div className="space-y-1.5 my-auto">
              <div className="w-36 h-3 bg-gradient-to-r from-blue-400 to-indigo-300 rounded-full" />
              <div className="w-48 h-2 bg-white/40 rounded-full" />
            </div>

            {/* Mockup Cards */}
            <div className="grid grid-cols-3 gap-2 pt-1 border-t border-white/5">
              <div className="h-8 bg-white/5 rounded-lg border border-white/5 p-1 flex items-center gap-1">
            ...
            <motion.div
              ...
              className="absolute top-0 left-0 pointer-events-none z-30 drop-shadow-md text-white"
            >
      ...
      <motion.div 
        ...
        className="w-[105px] sm:w-[125px] h-[190px] sm:h-[220px] bg-[#090D16] rounded-[24px] border-2 border-gray-800 p-2 shadow-2xl absolute -right-1 sm:right-6 sm:bottom-0 z-20 group-hover/stage:border-blue-500 transition-colors duration-300"
      >
        <div className="w-full h-full bg-[#0F172A] rounded-[18px] p-2 flex flex-col justify-between border border-white/10 relative overflow-hidden">
          
          {/* Top Notch */}
          <div className="w-8 h-1.5 bg-gray-700 rounded-full mx-auto mb-1" />
          ...
          <div className="space-y-2 my-auto">
            ...
            <div className="w-full h-2.5 bg-blue-400 rounded-full" />
            <div className="w-3/4 h-1.5 bg-white/40 rounded-full" />
            <div className="w-full h-10 bg-blue-500/10 rounded-xl border border-blue-400/20 p-1 flex flex-col justify-center gap-1">
              <div className="w-12 h-1 bg-white/60 rounded" />
              <div className="w-16 h-1 bg-white/30 rounded" />
            </div>
          </div>

          {/* Bottom Mobile Action Button with Pulse */}
          <motion.div 
            animate={{ scale: [1, 1.05, 1] }}
            transition={{ repeat: Infinity, duration: 3 }}
            className="w-full h-6 bg-[#2563EB] rounded-lg text-[8px] font-bold text-white flex items-center justify-center shadow-xs cursor-pointer"
          >
            Book Now
          </motion.div>
...
export function Features() {
  ...
  return (
    <section ref={sectionRef} className="py-10 md:py-14 bg-[#FAFAFA] relative overflow-hidden" id="features">
      ...
      <div className="max-w-[1300px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="text-center mb-6 md:mb-8 max-w-2xl mx-auto">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50/80 border border-blue-100 shadow-2xs mb-4"
          >
          ...
          <motion.h2 
            ...
            className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#0A0A0A] mb-4 tracking-tight font-sans leading-[1.15]"
          >
          ...
          <motion.p 
            ...
            className="text-base md:text-lg text-[#6B7280] leading-relaxed font-medium"
          >
        ...
        <motion.div 
          ...
          className="grid grid-cols-1 md:grid-cols-4 gap-5 auto-rows-[270px]"
        >
          ...
          <motion.div 
            ...
            className="md:col-span-2 md:row-span-2 bg-white border border-gray-200/90 rounded-[32px] p-6 sm:p-8 flex flex-col justify-between overflow-hidden relative shadow-sm group transition-all duration-300"
          >
            ...
            >
              <div className="flex items-center gap-3 overflow-hidden">
                ...
                <div className="truncate">
                  ...
                  <div className="text-xs font-bold text-[#2563EB] truncate hover:underline cursor-pointer">
                    Your Business Name — #1 Best Service in Town
                  </div>
                </div>
              </div>
        ...
        <motion.div 
          ...
          className="mt-12 bg-[#2563EB] rounded-[32px] p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl relative overflow-hidden group"
        >
          ...
          <div className="text-center md:text-left text-white relative z-10">
            ...
            <p className="text-blue-100 text-sm md:text-base font-medium">Everything above is included with every ProstoLabs plan.</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto relative z-10">
            <motion.a 
              ...
              whileTap={{ scale: 0.97 }}
              className="bg-white text-[#2563EB] px-6 py-3.5 rounded-xl font-bold text-sm hover:bg-blue-50 transition-all duration-300 shadow-md text-center flex items-center justify-center gap-2"
            >
            ...
            <motion.a 
              ...
              whileHover={{ scale: 1.03 }}
              whileTap={{ scale: 0.97 }}
              className="bg-blue-700/60 text-white border border-white/20 px-6 py-3.5 rounded-xl font-bold text-sm hover:bg-blue-800 transition-all duration-300 text-center"
            >
              Buy for ₹4,999
            </motion.a>
          </div>
