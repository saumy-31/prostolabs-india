...
export function CarePlanModal({ isOpen, onClose }: CarePlanModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    message += `\n📦 *Selected Plan:* Care Plan – ₹499/month`
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 md:p-6 overflow-hidden">
          ...
          <motion.div
            ...
            animate="visible"
            exit="exit"
            className="relative w-full max-w-[720px] max-h-[90vh] bg-white rounded-[24px] shadow-2xl border border-gray-100 flex flex-col overflow-hidden z-10 my-auto"
          >
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-5 md:p-6 space-y-3.5 custom-scrollbar">
              <form id="care-plan-modal-form" onSubmit={handleSubmit} className="space-y-3.5">
                ...
                <div className="bg-blue-50/70 border border-blue-100/90 rounded-2xl p-3.5 text-[#0A0A0A] space-y-2 mt-2">
                  <div className="flex items-center justify-between pb-2 border-b border-blue-100">
                    ...
                    <div className="text-right">
                      <span className="text-base sm:text-lg font-black text-[#2563EB]">₹499</span>
