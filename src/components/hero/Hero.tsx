...
export function Hero({ onOpenModal }: HeroProps) {
  ...
  return (
    <section 
      ...
      className="relative pt-14 md:pt-16 lg:pt-20 pb-4 md:pb-6 lg:pb-8 bg-[#FAFAFA] overflow-hidden select-none" 
      id="hero"
    >
      ...
      <div className="max-w-[1300px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-5">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50 border border-blue-100/90 shadow-2xs">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-[#0A0A0A] font-sans tracking-tight leading-[1.08]">
              {/* Line 1 */}
              ...
              {/* Line 2 & Price Star */}
              <div className="overflow-hidden flex flex-wrap items-center gap-x-3 pt-0.5">
                <motion.span
                  initial={{ y: "110%", opacity: 0 }}
                  animate={{ y: "0%", opacity: 1 }}
            ...
            <motion.div 
              ...
              className="pt-0.5"
            >
              <div className="inline-flex flex-wrap items-center gap-2 sm:gap-3 p-2 px-3.5 sm:px-4 rounded-2xl bg-white border border-gray-200/90 shadow-2xs text-xs font-semibold">
                <div className="flex items-center gap-1.5 text-gray-500">
                  <span>Traditional Agencies</span>
                  <span className="line-through text-gray-400 font-bold">₹20,000+</span>
                </div>
                <span className="text-gray-300 font-normal">→</span>
                <div className="flex items-center gap-1.5 text-[#2563EB] font-bold bg-blue-50/80 px-2.5 py-1 rounded-xl border border-blue-100">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-1">
              <motion.button 
                ...
                whileTap={{ scale: 0.97 }}
                className="bg-[#2563EB] text-white font-bold text-sm px-7 py-3.5 rounded-xl shadow-lg shadow-blue-500/20 hover:bg-blue-700 transition-all flex items-center justify-center gap-2 group text-center relative overflow-hidden cursor-pointer"
              >
              ...
              <motion.a 
                ...
                className="bg-white text-[#0A0A0A] border border-gray-200/90 font-bold text-sm px-6 py-3.5 rounded-xl transition-all text-center shadow-2xs cursor-pointer"
              >
                View Pricing
              </motion.a>
            </div>
          ...
          {/* RIGHT COLUMN: BROWSER PREVIEW (5 COLS) */}
          <motion.div 
